...
1. Check if our arrays have the same amount of elements.
 ...
 2. If yes -> we check if each element in nums1 equal to each element in nums2.
  If  we find at least 1 case when element on certein position in nums1 is not equal
  to elemrnt from nums2 on the same position.
  Then we do not need to check all other cases (use key word brake)
   and we know for sure our arrays are not equal.
        */
